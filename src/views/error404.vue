<template >
    <div>
        <div class="ppperror404" style="height:100vh;padding-top:200px" >
...
//   metaInfo() {
//     const title  = this.$t('title.error404');
//     return {title};
//   },
    ...
    beforeMount() {
      this.path = this.$router.history.current.params.pathMatch;
...
<style lang="scss" scoped >
    ...
    .ppperror404 { 
      ...
      width: 100vw;
       z-index: 999999;
      background-color: #3d5674; font-family: 'Tahoma'; margin: 0; overflow: hidden; padding: 0; }
...
.caveman:nth-child(2) .head1 {
  animation: head1-anima 1.2s infinite cubic-bezier(.55,.01,.16,1.34);
}
.caveman:nth-child(1) .head1 {
  animation: head1-anima 1.2s infinite cubic-bezier(.55,.01,.16,1.34);
  animation-delay: 0.6s;
}
@keyframes head1-anima {
  0%    { top: 25px; }
  42%   { top: 25px; }
  45%   { top: 50px; }
  100%  { top: 25px; }
